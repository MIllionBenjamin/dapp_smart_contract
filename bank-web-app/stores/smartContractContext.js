...
export const SmartContractContextProvider = ({ children }) => {
	...
	const CarRentalSmartContractContract = new web3.eth.Contract(CarRentalSmartContractArtifact.abi, carRentalSmartContractAddress);

	const context = { MicroTokenContract, UserIdentityContract, BankLoanContract, CarRentalSmartContractContract };
